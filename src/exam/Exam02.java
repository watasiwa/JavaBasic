	 ...
	 *[2-4] 다음 중 기본형 이 아닌 것은 (primitive type) ?  b
		...
		d. boolean
			...
			System.out.println(true + null) → ( )
			  ...
			  [2-6] 다음 중 키워드가 아닌 것은 모두 고르시오 ?(d,e )
			a. if
			b. True
			c. NULL
			d. Class
			 ...
			 *
			 *
			 [2-8] 참조형 변수 와 같은 크기의 기본형 은 모두 고  ? (a, d)
			a. int
			b. long
			c. short
			d. float
			...
			[2-10] char타입의 변수에 저장될 수 있는 정수 값의 범위는? ? (10 )
			 - (0~65335)
			 
			 [2-11] 다음중 변수를 잘못 초기화 한 것은 모두 고르시오 ? (a,b,c,d,e)
			a. byte b = 256;
			b. char c = '';
			c. char answer = 'no';
			d. float f = 3.14
			...
			[2-12] 다음 중 메서드의 선언부로 알맞은 것은 모두 고르시오 main ? (a )
