...
public class Exam03 {
	...
	public static void main(String[] args) {
		...
		//  System.out.println(1 + x << 33);
				System.out.println(1 + x << 33);      // 결과 값 6
				
		//  System.out.println(y >= 5 || x < 0 && x > 2);
 				System.out.println(y >= 5 || x < 0 && x > 2);  //결과 값 true
		//  System.out.println(y += 10 - x++);
 				System.out.println(y += 10 - x++);          //결과 값 13
		//  System.out.println(x+=2);
 				System.out.println(x+=2);                  // 결과 값 5
		//  System.out.println( !('A' <= c && c <='Z') );
 				System.out.println( !('A' <= c && c <='Z') );     // 결과 값 false
		//  System.out.println('C'-c);
 				System.out.println('C'-c);                  // 결과 값 2
		//  System.out.println('5'-'0');
 				System.out.println('5'-'0');                // 결과 값 5
		//  System.out.println(c+1);
 				System.out.println(c+1);                    // 결과 값 66
		//  System.out.println(++c);
 				System.out.println(++c);                    // 결과 값 B
		//  System.out.println(c++);
 				System.out.println(c++);                    // 결과 값 B
		//  System.out.println(c);
 				System.out.println(c);                      // 결과 값 C
...
// 				
 				...
 				public static void main(String[] args) {
 				int num = 10;
 				S8ystem.out.println(  num >= 1 ? "양수" : num == 0 ? "0" : "음수" );
 				}
 				}
 				실행결과 : 양수
...
/* 				[3-6] 아래는 변수 num의 값보다 크면서도 가장 가까운 10의 배수에서 변수 num의 값을
 				...
 				public static void main(String[] args) {
 				int num = 24;
 				System.out.println(  (1) 10-num3%10 );
 				}
 				}
 				...
 				public static void main(String[] args) {
 				int fahrenheit = 100;
 				float celcius = (  (1)  ); (float) (int)(((5/9f * (fahrenheit - 32))+0.005f)*100)*0.01f ;
